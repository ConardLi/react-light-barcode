...
var Code128 = function (_React$Component) {
  _inherits(Code128, _React$Component);
  ...
  function Code128() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Code128.__proto__ || Object.getPrototypeOf(Code128)).call.apply(_ref, [this].concat(args))), _this), _this.code128 = function (code, barcodeType) {
      ...
      if (_arguments.length < 2) barcodeType = _this.code128Detect(code);
    ...
    }, _this.code128Detect = function (code) {
